...
df = pd.read_csv(
    "../../Downloads/pythonProgramlama2-220723-135945/pythonProgramlama/python_for_data_science/data_analysis_with_python/datasets/advertising.csv")
df.head()
# pandas cheatsheet
...
pd.set_option('display.width', 500)
df = pd.read_csv(
    "../../Downloads/pythonProgramlama2-220723-135945/pythonProgramlama/python_for_data_science/data_analysis_with_python/datasets/breast_cancer.csv")
df = df.iloc[:, 1:-1]
df.head()
